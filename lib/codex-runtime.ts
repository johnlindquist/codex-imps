/**
 * Shared runtime helpers for isolated Codex daemon profiles.
 *
 * Self-improvement is owned by lib/self-improve.ts and is available to every
 * daemon through this shared runtime. It is opt-in: normal profiles remain a
 * no-op unless `selfImprove.enabled` or CODEX_DAEMON_SELF_IMPROVE enables them.
 */
import {
  chmodSync,
  copyFileSync,
